...
namespace GoatWebShop.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Price,Name,Description,Photo,AmountInStock,Category_ID,Supplier_ID,Deleted")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Price,Name,Description,Photo,AmountInStock,Category_ID,Supplier_ID,Deleted")] Product product)
        {
            if (ModelState.IsValid)
            {
